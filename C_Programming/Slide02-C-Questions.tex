...
printf内的b看的是外部变量b，因其位全局变量，默认初始化为0\\
i++只会影响循环次数，不会影响最终结果
\end{frame}
...
\end{lstlisting}
24 120，涉及到对齐问题，详情可见\footnote{\url{https://stackoverflow.com/questions/119123/why-isnt-sizeof-for-a-struct-equal-to-the-sum-of-sizeof-of-each-member}}
\end{frame}
