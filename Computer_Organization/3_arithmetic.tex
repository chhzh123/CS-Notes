...
\par大于机器所能表示的最大正数称为上溢，小于机器所能表示的最小负数称为下溢
\par算术左移溢出判断：若移出的位不等于新的符号位，即$CF\oplus SF=1$，则溢出
...
如$1111-1101=[01111]_c+[10011]_c=[100010]_c$，进位但不溢出（补码往前往后模特性，只有\textbf{补码}有）\\
